...
## Video record (2026-09-08 — Veo 3.1 + ffmpeg)
...
| Generated by     | **Veo 3.1** (`veo-3.1-generate-preview`, Quality 1080p) — image-to-video from the cityscape AVIF (16:9 + 9:16 separate clips), 8s (Veo 3.1 image-to-video only supports 8s), no audio, 24fps, **boomerang loop** (advance + reverse = mathematically seamless). Start frame exported PNG/WebP for the API call (Veo input max 20MB, JPEG/PNG/WebP — NOT AVIF). |
...
| Re-encoded with  | **ffmpeg** (one-off, NOT a runtime dependency): H.264 CRF 26 (16:9) / CRF 30 (9:16), no audio track, 24fps.                                                                                                 |
| Final files      | `public/hero/hero-16x9.mp4` — **1920×1080, 8s, 24fps, H.264, no audio, 3.13 MB** (budget ≤4MB ✓) · `public/hero/hero-9x16.mp4` — **720×1280, 8s, 24fps, H.264, no audio, 1.03 MB** (budget ≤2MB ✓). |
